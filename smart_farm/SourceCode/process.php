...
if (isset($_POST['action'])) {
    if ($_POST['action'] == 'add') {
        ...
        // if (strlen($code) > 5) {
        //     echo "❌ Error: Kode produk maksimal 5 karakter.";
        // } elseif (strlen($name) > 50) {
        //     echo "❌ Error: Nama produk maksimal 50 karakter.";
        // } elseif (!is_numeric($price) || $price > 999999999999) {
        //     echo "❌ Error: Harga produk maksimal 12 karakter.";
        // }
